...
import com.sn.go4lunch.Fragment.MateFragment;
import com.sn.go4lunch.Fragment.ListFragment;
    ...
    private void showFragment(int fragmentIdentifier) {
        ...
        switch (fragmentIdentifier) {
            ...
            case MainActivity.FRAGMENT_MATES:
                newFragment = MateFragment.newInstance();
    ...
    private void updateUIWhenCreating() {
        ...
        if (this.getCurrentUser() != null) {
            ...
            String email = TextUtils.isEmpty(
                    this.getCurrentUser().getEmail()) ? getString(R.string.info_no_email_found) :
                    this.getCurrentUser().getEmail();
            String name = TextUtils.isEmpty(
                    this.getCurrentUser().getDisplayName()) ? getString(R.string.info_no_username_found) :
