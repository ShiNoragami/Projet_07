...
import com.sn.go4lunch.Utils.MinMaxFilter;
import com.sn.go4lunch.Utils.Notification.NotificationHelper;
...
public class SettingsActivity extends BaseActivity {
    ...
    Button mButtonSave;
    @BindView(R.id.settings_radius_edit_text)
    TextInputEditText mRadiusEditText;
    @BindView(R.id.settings_zoom_edit_text)
    TextInputEditText mZoomEditText;
    @BindView(R.id.settings_zoom_edit_layout)
    TextInputLayout mZoomEditLayout;
    @BindView(R.id.settings_radius_edit_layout)
    TextInputLayout mRadiusEditLayout;
    ...
    private void setListenerAndFilters(){
        ...
        mZoomEditText.setFilters(new InputFilter[]{new MinMaxFilter(ZOOM_MIN_VALUE,ZOOM_MAX_VALUE)});
        mRadiusEditText.setFilters(new InputFilter[]{new MinMaxFilter(RADIUS_MIN_VALUE,RADIUS_MAX_VALUE)});
    }
