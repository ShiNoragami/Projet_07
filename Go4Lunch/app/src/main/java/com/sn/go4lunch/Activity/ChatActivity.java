...
import com.sn.go4lunch.Api.MessageHelper;
...
import com.sn.go4lunch.View.ChatAdapter;
...
public class ChatActivity extends BaseActivity implements ChatAdapter.Listener {
        ...
        if (!TextUtils.isEmpty(editTextMessage.getText()) && modelCurrentUser != null) {
            ...
            if (this.imageViewPreview.getDrawable() == null) {
                ...
                MessageHelper.createMessageForChat(
                        editTextMessage.getText().toString(), modelCurrentUser).addOnFailureListener(this.onFailureListener());
    ...
    private void configureRecyclerView(){
        this.mChatAdapter = new ChatAdapter(generateOptionsForAdapter(
                (Query) MessageHelper.getAllMessageForChat()),
    ...
    private FirestoreRecyclerOptions<Message> generateOptionsForAdapter(Query query){
        return new FirestoreRecyclerOptions.Builder<Message>()
                .setQuery((com.google.firebase.firestore.Query) query, Message.class)
